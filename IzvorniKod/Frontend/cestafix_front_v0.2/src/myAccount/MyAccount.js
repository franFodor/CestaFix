        ...
        switch(loggedUser ? loggedUser.role : null){
            case 'USER':
              ...
              <div className='myAccRight'>
                ...
                {buttonClicked === 'b' && <ReportList />}{buttonClicked === 'c' && 
               <div className='deletionDiv'>
                 <p>Jeste li sigurni da želite probrisati račun? Ova radnja ne može biti poništena.</p>
                <button onClick={handleDeletion}>Confirm Deletion</button>
            ...
            <img src={userImage} alt="User" />
            <div className='Details'>{loggedUser.firstname +' '+ loggedUser.lastname}</div>
            <button className='confirmButton' style={{display: 'inline-block', width: 'fit-content'}} onClick={() => handleClick('a')}>Ažuriraj stanje Prijava!</button>
            <button className='confirmButton' style={{display: 'inline-block', width: 'fit-content'}} onClick={() => handleClick('b')}>Spoji prijave!</button>
            <button className='confirmButton' style={{display: 'inline-block', width: 'fit-content', background: 'red'}} onClick={() => handleClick('c')}>Pobriši Račun!!!</button>
            <button className='confirmButton' style={{display: 'inline-block', width: 'fit-content'}} onClick={() => window.location.href = '/'}>Povratak</button>
          </div>
