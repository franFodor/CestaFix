\chapter{Implementacija i korisničko sučelje}
		...
		\section{Ispitivanje programskog rješenja}
			...
			Postoji sveukupno 6 integracijskih testova - 5 njih za modele koji reprezentiraju entitete u bazi te još jedan za registraciju i prijavu korisnika.
            ...
            Nakon toga izvršava se funkcija koja je anotirana s @BeforeEach anotacijom. 
			Funkcija koja ima anotaciju @BeforeEach će se izvršiti prije svakog testa.
            Također, postoji i funkcija koja je anotirana s @AfterEach anotacijom. 
			Ona će se izvršiti poslije svakog testa.
            Sami testovi su anotirani s anotacijom @Test.
			Sve navedene anotacije pripadaju org.junit biblioteci.
            \begin{figure}[H]
                \includegraphics[scale=0.60]{slike/IT_containerized_docker.png}
                \centering
                \caption{Primjer dizanja baze u integracijskom testu}
                \label{fig:IT_docker}
            \end{figure}
            ...
            \begin{figure}[H]
                ...
                \centering
                \caption{Primjer umetanja podataka u bazu}
			...
			\begin{figure}[H]
                \includegraphics[scale=1.00]{slike/IT_test.png}
                \centering
            ...
            \vspace{10pt}
			\begin{figure}[H]
                \includegraphics[scale=0.80]{slike/IT_afterEach.png}
                \centering
                \caption{Primjer brisanja podataka iz baze nakon testa}
                \label{fig:afterEach}
            \end{figure}
